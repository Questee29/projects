...
<head>
    ...
    <link rel="stylesheet" href="css/catalog.css?<? echo time(); ?>">
    <meta property="og:image" content="img/section-top/shop.webp" />
...
<body>
            ...
            <div class="header-page__end">
                <nav class="header-page__nav">
                    <ul class="header-page__ul">
                        ...
                        <li class="header-page__li">
                            <a class="header-page__link" href="basket.php">
    ...
    <!-- section-top -->
    <section class="section-top lazy" data-src="img/section-top/shop.webp">
        <div class="container section-top__container">
            <h1 class="section-top__title">Лучшая одежда в Европе</h1>
            <div class="section-top__btn">
                <button class="btn" type="button" data-scroll-to="section-catalog">Смотреть</button>
            </div>
        </div>
    </section>
    <!-- /.section-top -->
            ...
            <header class="section__header">
                ...
                <nav class="catalog-nav">
                    <ul class="catalog-nav__wrapper">
                        ...
                        $query = "select name_category from category;";
                        $result = mysqli_query($connection, $query) or die("Ошибка " . mysqli_error($connection));
                        if ($result) {
                            while ($row = mysqli_fetch_row($result)) {
                                echo '<li class="catalog-nav__item">';
                                echo '<button class="catalog-nav__btn" type="button" data-filter="' . $row[0] . '">' . $row[0] . '</button>';
                                echo '</li>';
                            }
                        }
                        ?>
            ...
            <div class="catalog">
                ...
                if ($result) {
                    while ($row = mysqli_fetch_row($result)) {
                        ...
                        echo              '<input type="submit" class="btn product__btn" name="addProduct" data-popup="popup-order" value="Добавить в корзину">';
                        echo            '</form>';
                        echo         '</div>';
                        echo      '</footer>';
                        echo   '</div>';
                ...
                if (isset($_POST['addProduct'])) {
                    ...
                    $queryAdd = "INSERT INTO basket (id_basket, `id_product`, `date`, `time`) 
                            VALUES (NULL, '" . $productId . "', '" . $date . "', '" . $time . "');";
                    $resultAdd = mysqli_query($connection, $queryAdd) or die("Ошибка " . mysqli_error($connection));
                }
                ?>
            </div>
        </div>
    ...
    <section class="section section-about">
        <picture>
            <img class="section-about__img lazy" src="img/section-top/shop.webp" alt="">
        </picture>
        <div class="container section-about__container">
            <div class="section-about__content">
                <h2 class="page-title section-about__title">О нас</h2>
                <p class="section-about__text">Мы предлагаем самые низкие цены, дешевле вы не найдете. Вашему вниманию
                    самый широкий ассортимент товаров на всём рынке. Ждём вас за покупками каждый день, мы всегда к
                    вашим услугам!</p>
            </div>
        </div>
    </section>
                                ...
                                <a href="#" class="socials__link" target="_blank">
                                    <svg class="socials__icon socials__icon--inst" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g>
                                            ...
                                            <path
                                                d="M256,210.9a45.8,45.8,0,1,0,45.8,45.8A45.86,45.86,0,0,0,256,210.9Z" />
                                            <path
                    ...
                    <nav class="mobile-menu popup__mobile-menu">
                        <ul class="mobile-menu__ul">
                            <li class="mobile-menu__li">
                                <a class="mobile-menu__link popup-close" href="#"
                                    data-scroll-to="section-catalog">Каталог</a>
                            </li>
                            <li class="mobile-menu__li">
                                <a class="mobile-menu__link popup-close" href="#" data-scroll-to="section-about">О
                                    нас</a>
                            </li>
                            <li class="mobile-menu__li">
                                <a class="mobile-menu__link popup-close" href="#"
                                    data-scroll-to="section-contacts">Контакты</a>
                            </li>
                        </ul>
                    </nav>
